        ...
        $countries = [
            [
                ...
                'url_patterns' => [
                    ...
                    'city' => '/{city}',
                    'admin_division_1' => '/region/{admin_division}',
                    'admin_division_2' => '/departement/{admin_division}',
            ...
            [
                ...
                'url_patterns' => [
                    ...
                    'city' => '/{city}',
                    'admin_division_1' => '/region/{admin_division}',
                    'admin_division_2' => '/province/{admin_division}',
                    'activity' => '/activite/{activity}',
                    'sector' => '/secteur/{sector}',
                ],
            ...
            [
                ...
                'url_patterns' => [
                    ...
                    'activity_city' => '/{city}/{activity}',
                    'city' => '/{city}',
                    'admin_division_1' => '/gouvernorat/{admin_division}',
                    'admin_division_2' => '/delegation/{admin_division}',
                    'activity' => '/activite/{activity}',
                    'sector' => '/secteur/{sector}',
                ],
            ...
            [
                ...
                'url_patterns' => [
                    ...
                    'city' => '/{city}',
                    'admin_division_1' => '/region/{admin_division}',
                    'admin_division_2' => '/prefecture/{admin_division}',
                    'activity' => '/activite/{activity}',
                    'sector' => '/secteur/{sector}',
                ],
                'source_config' => ['open_data' => []],
            ...
            [
                ...
                'url_patterns' => [
                    ...
                    'activity_city' => '/{city}/{activity}',
                    'city' => '/{city}',
                    // Un seul niveau administratif (wilaya) : la commune est
                    // déjà représentée par `City`, pas de niveau 2 distinct.
                    'admin_division_1' => '/wilaya/{admin_division}',
                    'activity' => '/activite/{activity}',
                    'sector' => '/secteur/{sector}',
                ],
                'source_config' => ['open_data' => []],
            ...
            [
                ...
                'url_patterns' => [
                    ...
                    'city' => '/{city}',
                    'admin_division_1' => '/region/{admin_division}',
                    'admin_division_2' => '/mrc/{admin_division}',
                    'activity' => '/activite/{activity}',
                    'sector' => '/secteur/{sector}',
                ],
