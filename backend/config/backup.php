    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // Uniquement les données non recréables : fichiers uploadés
                // (ex. company_claims.evidence_path, dispute_reports.evidence_path).
                // Pas base_path() entier — le code applicatif vit dans le
                // dépôt git, pas dans la sauvegarde.
                'include' => [
        ...
        'destination' => [
            ...
            /*
             * The disk names on which the backups will be stored. Hors-site
             * différé faute de bucket/identifiants disponibles : le disque
             * `s3` existe déjà dans config/filesystems.php, il suffira
             * d'ajouter 's3' ici + les AWS_* dans .env le jour venu, sans
             * changement de code (voir docs/deployment.md).
             */
            'disks' => [
                'backups',
            ],
