...
use App\Filament\Resources\CityContentResource\Pages;
...
class CityContentResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListCityContents::route('/'),
            'create' => Pages\CreateCityContent::route('/create'),
            'edit' => Pages\EditCityContent::route('/{record}/edit'),
        ];
    }
}
