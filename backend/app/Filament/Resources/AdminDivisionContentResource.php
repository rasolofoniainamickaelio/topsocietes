...
use App\Filament\Resources\AdminDivisionContentResource\Pages;
...
class AdminDivisionContentResource extends Resource
{
    protected static ?string $model = AdminDivisionContent::class;
    ...
    {
        return $form->schema([
            Select::make('admin_division_id')->relationship('adminDivision', 'name')->searchable()->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('adminDivision.name')->label('Division')->searchable()->sortable(),
    ...
    {
        return [
            'index' => Pages\ListAdminDivisionContents::route('/'),
            'create' => Pages\CreateAdminDivisionContent::route('/create'),
            'edit' => Pages\EditAdminDivisionContent::route('/{record}/edit'),
        ];
    }
}
